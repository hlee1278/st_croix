...
EXPECTED INPUT FILES:
    ...
    heat mapping combining script, combining_excluding_missing_gps.py
    Examples:
...
FOLDER = r"C:\Users\dresd\USVI_2026\combined_data\0607_R17\lat_long_present_R17"  # Windows example
...
def plot_temp_vs_time(folder):
    ...
    fig.text(
        ...
        'Only pocket lab data with GPS coordinates',
        ha='center',
        fontsize=10,
        style='italic',
        color='dimgray'
